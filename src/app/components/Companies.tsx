...
const Companies = () => {
    ...
    return (
        <div className='mx-auto mt-[111px] h-full overflow-hidden' dir='ltr'>
            <h2 className='text-5xl md:text-7xl font-extrabold text-primary font-beiruti leading-tight text-center mb-16' dir='rtl'>
                الوكلاء
            </h2>
